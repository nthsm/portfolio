...
export const metadata: Metadata = {
  ...
  description: "Usability benchmark comparing Sleeper's social features to competitors.",
}
  ...
  return (
    <div className="imon-parallax-container">
        ...
        >
            ...
            <p className="subtitle">Usability benchmark comparing Sleeper's social features to competitors.</p>
        </ParallaxHeader>

      ...
      <div className="imon-content-wrapper">
        <div className="content-section">
          <div className="imon-content-inner clearfix">
            ...
            <p>
              ...
              biased hypothesis, testing that hypothesis against real user data,
              and ultimately pivoting to a set of recommendations that were far
              more targeted, effective, and achievable for a non-profit client.
        ...
        <div className="content-section">
          <div className="imon-content-inner clearfix">
            ...
            <p>
              Based on my heuristic evaluation, I hypothesized that the website
              required a comprehensive redesign. My review identified several
              usability issues:
            </p>
            ...
            <p>
              ...
              these aesthetic and heuristic flaws would automatically translate
              to a poor user experience and deter users.
            </p>
        ...
        <div className="content-section">
          <div className="imon-content-inner clearfix">
            ...
            <figure className="my-4 flex flex-col items-center">
              ...
              />
              <figcaption>
                A representative quote from usability testing highlighting the
                Shelterluv friction.
              </figcaption>
            </figure>
          </div>
        ...
        <div className="content-section">
          <div className="imon-content-inner">
            ...
            <p>
              Instead of an unnecessary redesign, I pivoted to a set of
              targeted, data-driven recommendations that would address actual
            ...
            <ol>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Break up large blocks of text to improve scannability. This
                    is key.
                  </li>
                </ul>
              </li>
        ...
        <div className="content-section">
          <div className="imon-content-inner">
            ...
            <p>
              ...
              data over my own opinion, I was able to move from a costly,
              unnecessary redesign proposal to a set of simple, high-impact
              recommendations that directly address documented user needs.
            </p>
            <p>
